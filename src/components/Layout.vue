  ...
  <div>
    <div class="main-wrapper main-wrapper-1">
        ...
        <form class="form-inline mr-auto">
          ...
          <div class="search-element">
            ...
            <div class="search-result">
              <div class="search-header">搜索历史</div>
              ...
              <div class="search-item">
                <a href="#">
                  <img
                    class="mr-3 rounded"
                    width="30"
                    src="/static/img/products/product-3-50.png"
                    alt="product"
                  />
                  知乎
                </a>
              ...
              <div class="search-item">
                <a href="#">
                  <img
                    class="mr-3 rounded"
                    width="30"
                    src="/static/img/products/product-2-50.png"
                    alt="product"
                  />
                  v2ex
                </a>
      ...
      <footer class="main-footer">
        <div class="footer-left">Copyright &copy; Oh Today 2019</div>
